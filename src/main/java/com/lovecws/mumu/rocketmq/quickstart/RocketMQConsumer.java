...
public class RocketMQConsumer {
    ...
    public void receivePullMessage(){
        ...
        try {
            ...
            for(MessageQueue messageQueue:messageQueues){
                PullResult pullResult = consumer.pull(messageQueue, "*", 0l, 100);
                System.out.println(pullResult);
            }
            TimeUnit.SECONDS.sleep(10);
            messageQueues = consumer.fetchSubscribeMessageQueues(RocketMQConfiguration.ROCKETMQ_TOPIC);
            System.out.println(messageQueues);
    ...
    public static void main(String[] args) {
        ...
        new RocketMQConsumer().receivePullMessage();
    }
}
